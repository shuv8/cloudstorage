...
class TestBase:
    ...
    def test_dir_content(self, app_client_user):
        response = app_client_user.get(
            path=f'/get_dir/abd9cd7f-9ffd-42b0-bce4-eb14b51a1fd1/abd9cd7f-9ffd-42b0-bce4-eb14b51a1fa4')
        assert response.status_code == 200
        ...
        response = app_client_user.get(
            path=f'/get_dir/abd9cd7f-9ffd-42b0-bce4-eb14b51a1fd0/abd9cd7f-9ffd-42b0-bce4-eb14b51a1fa0')
        assert response.status_code == 404
