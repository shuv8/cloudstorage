class TestDownloadController:
    ...
    def test_download_file(self, app_client_user):
        response = app_client_user.get(path='/download/abd9cd7f-9ffd-41b0-bce4-eb14b51a6d71')
        assert response.status_code == 200

    def test_download_directory(self, app_client_user):
        response = app_client_user.get(path='/download/4c3b76d1-fe24-4fdf-afdf-7c38adbdab15')
        assert response.status_code == 200
